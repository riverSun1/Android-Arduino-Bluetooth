...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button connectButton = findViewById(R.id.button); // connect 버튼
        ...
        if (deviceName != null) { // 데이터를 가져올 디바이스가 있다면
            ...
            textView2.setText("Connecting to " + deviceName + "...");
            ...
            seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                ...
                public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                    ...
                    cmdText = Integer.toString(progress)+'\r'; // 정수를 문자열로 형변환
                    //cmdText = "123\r"; // 49 50 51 13 아스키토드 10진수
                ...
                public void onStopTrackingTouch(SeekBar seekBar) {
                    ...
                    //cmdText = Integer.toString(seekBar.getProgress()); // 정수를 문자열로 형변환
                    //connectedThread.write(cmdText);
                }
            });
        }
